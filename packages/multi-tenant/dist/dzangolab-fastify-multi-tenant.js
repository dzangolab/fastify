...
const Le = async (n, t, e) => {
...
}, ot = { Mutation: xe, Query: ke }, Me = async (n, t) => {
  if (n.tenant)
    throw {
  ...
  t.send(c);
}, C = { all: Me, create: qe, tenant: Ve, tenants: We }, it = async (n, t, e) => {
  n.get(
    "/tenants/all",
    {
...
export {
  w as TenantService,
  De as default,
  at as tenantMigrationPlugin,
  ot as tenantResolver,
  it as tenantRoutes,
  Pe as thirdPartyEmailPassword,
  rt as validateTenantSchema
};
