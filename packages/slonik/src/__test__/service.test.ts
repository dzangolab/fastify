...
describe("Service", async () => {
  ...
  db.public.none(`
    create table public.test(id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, name TEXT, latitude INT, country_code TEXT);
    insert into public.test (name, latitude, country_code) values ('Test1', 20, 'NP'), ('Test2', 30, 'US');
