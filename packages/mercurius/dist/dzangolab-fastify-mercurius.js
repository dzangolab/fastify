...
const we = async (e, n) => {
  const t = e.config.mercurius.plugins, i = {
    config: e.config,
    database: e.slonik,
    dbSchema: e.dbSchema
  };
...
function R(e, n, t) {
  const i = K(e), r = K(n);
  return typeof t == "function" ? t(i, r) : ze(i, r);
}
function G(e) {
  return e != null;
}
  ...
  if (n)
    try {
      return {
        ...
        fields: z(e, e.fields, n.fields, t),
        directives: I(e.directives, n.directives, t, i),
        interfaces: e.interfaces ? q(e.interfaces, n.interfaces, t) : void 0
      };
    } catch (r) {
...
const qn = new Set(Object.keys(Oe));
function Kn(e) {
  const n = e?.kind;
  return typeof n == "string" && qn.has(n);
}
var H;
  ...
  if (n)
    try {
      return {
        ...
        fields: z(e, e.fields, n.fields, t),
        directives: I(e.directives, n.directives, t, i),
        interfaces: q(e.interfaces, n.interfaces, t)
      };
    } catch (r) {
