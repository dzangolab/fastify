...
declare const PERMISSIONS_INVITIATIONS_CREATE = "invitations:create";
declare const PERMISSIONS_INVITIATIONS_LIST = "invitations:list";
declare const PERMISSIONS_INVITIATIONS_RESEND = "invitations:resend";
declare const PERMISSIONS_INVITIATIONS_REVOKE = "invitations:revoke";
...
export { EMAIL_VERIFICATION_MODE, EMAIL_VERIFICATION_PATH, INVITATION_ACCEPT_LINK_PATH, INVITATION_EXPIRE_AFTER_IN_DAYS, PERMISSIONS_INVITIATIONS_LIST, PERMISSIONS_INVITIATIONS_RESEND, PERMISSIONS_INVITIATIONS_REVOKE, PERMISSIONS_USERS_DISABLE, PERMISSIONS_USERS_ENABLE, PERMISSIONS_USERS_LIST, RESET_PASSWORD_PATH, ROLE_ADMIN, ROLE_SUPER_ADMIN, ROLE_USER, ROUTE_CHANGE_PASSWORD, ROUTE_INVITATIONS, ROUTE_INVITATIONS_ACCEPT, ROUTE_INVITATIONS_CREATE, ROUTE_INVITATIONS_GET_BY_TOKEN, ROUTE_INVITATIONS_RESEND, ROUTE_INVITATIONS_REVOKE, ROUTE_ME, ROUTE_PERMISSIONS, ROUTE_ROLES, PERMISSIONS_INVITIATIONS_CREATE, ROUTE_ROLES_PERMISSIONS, ROUTE_SIGNUP_ADMIN, ROUTE_USERS, ROUTE_USERS_DISABLE, ROUTE_USERS_ENABLE, TABLE_INVITATIONS, TABLE_USERS, };
