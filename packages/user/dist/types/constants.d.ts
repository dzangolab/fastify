...
declare const ROUTE_INVITATIONS_DELETE = "/invitations/:id(^\\d+)";
...
declare const ROUTE_USERS_FIND_BY_ID = "/users/:id";
...
declare const PERMISSIONS_INVITATIONS_DELETE = "invitations:delete";
...
declare const PERMISSIONS_USERS_LIST = "users:list";
declare const PERMISSIONS_USERS_READ = "users:read";
export { EMAIL_VERIFICATION_MODE, EMAIL_VERIFICATION_PATH, INVITATION_ACCEPT_LINK_PATH, INVITATION_EXPIRE_AFTER_IN_DAYS, PERMISSIONS_INVITATIONS_DELETE, PERMISSIONS_INVITATIONS_LIST, PERMISSIONS_INVITATIONS_RESEND, PERMISSIONS_INVITATIONS_REVOKE, PERMISSIONS_USERS_DISABLE, PERMISSIONS_USERS_ENABLE, PERMISSIONS_USERS_LIST, PERMISSIONS_USERS_READ, RESET_PASSWORD_PATH, ROLE_ADMIN, ROLE_SUPERADMIN, ROLE_USER, ROUTE_CHANGE_PASSWORD, ROUTE_INVITATIONS, ROUTE_INVITATIONS_ACCEPT, ROUTE_INVITATIONS_CREATE, ROUTE_INVITATIONS_DELETE, ROUTE_INVITATIONS_GET_BY_TOKEN, ROUTE_INVITATIONS_RESEND, ROUTE_INVITATIONS_REVOKE, ROUTE_ME, ROUTE_PERMISSIONS, ROUTE_ROLES, ROUTE_USERS_FIND_BY_ID, PERMISSIONS_INVITATIONS_CREATE, ROUTE_ROLES_PERMISSIONS, ROUTE_SIGNUP_ADMIN, ROUTE_USERS, ROUTE_USERS_DISABLE, ROUTE_USERS_ENABLE, TABLE_INVITATIONS, TABLE_USERS, };
